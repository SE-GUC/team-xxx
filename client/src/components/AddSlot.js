...
import { Button, Form, FormGroup, Label, Input, FormText,Alert,Col } from 'reactstrap';
  ...
  render() {
    return (
        ...
        <FormGroup>
          ...
          <Input type="text" name="lifecoachEmail" id="lifecoachEmail" 
        ...
        <FormGroup>
          ...
          id="number"  onChange={this.onChange}/>
        </FormGroup>
        <FormGroup>
          <Label for="Date">Date </Label>
          <Input type="date" name="Date" 
          id="Date"  onChange={this.onChange}/>
        </FormGroup>
        <FormGroup>
          <Label for="startTime">Start Time</Label>
          <Input type="date" name="startTime" 
          id="startTime"  onChange={this.onChange} />
        </FormGroup>
        <FormGroup>
          <Label for="endTime">End Time</Label>
          <Input type="date" name="endTime" 
          id="endTime" onChange={this.onChange} />
        </FormGroup>
        <FormGroup>
