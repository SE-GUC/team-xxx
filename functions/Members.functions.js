...
const functions = {
  ...
  getcontract: async () => {
    const contract = await axios
      .get(
        "http://localhost:5000/api/Members/Contracts/5c9a19ae48798e3068ae4108"
      )
      .catch(err => "error");
    return contract;
  },
  getmembership: async () => {
    const membership = await axios
      .get(
        "http://localhost:5000/api/Members/membership/5c9a19ae48798e3068ae4108"
      )
      .catch(err => "error");
    return membership;
  },
  ...
  getnotificatons: async () => {
    const noti = await axios
      .get(
        "http://localhost:5000/api/Members/Notifications/5c9a104c8bf8e51ea427ba96"
      )
      .catch(err => "error");
    return noti;
  }
